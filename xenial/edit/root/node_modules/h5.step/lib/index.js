...
function step()
{
  ...
  function nextStep()
  {
    ...
    var result = step.apply(context, arguments);

    if (result && result.then && result.catch)
    {
      result
        .then(function(result) { continueStep(null, result); })
        .catch(function(err) { continueStep(err, null); });
    }
    else
    {
      continueStep();
  ...
  function continueStep(err, result)
  {
